...
export type WhatsAppInboundResultOrPromise = WhatsAppInboundResult | Promise<WhatsAppInboundResult>;
...
export interface WhatsAppChannelConfig {
    ...
    readonly onMessage?: (ctx: WhatsAppContext, message: WhatsAppMessage) => WhatsAppInboundResultOrPromise;
...
export interface WhatsAppHandle {
    ...
    sendButtons(input: WhapiButtonsInput): Promise<{
        id: string | undefined;
    }>;
