...
import { loadIndex, saveIndex, serializeIndex, storeFromArtifact, } from "./index-store.js";
...
test("loadWikiDir derives section from folder and links from wikilinks", async () => {
    ...
    try {
        ...
        await writeFile(join(dir, "finance", "bonds.md"), "# Bonds\n\nSee [[Coupons]] and [[Rates|interest rates]].");
...
//# sourceMappingURL=index-store.test.js.map