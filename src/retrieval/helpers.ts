...
export function inScope(doc: WikiDoc, scope?: RetrievalScope): boolean {
  if (!scope) return true;
  if (scope.vault && doc.vault !== scope.vault) return false;
...
export function confidenceFrom(chunks: ScoredChunk[]): number {
