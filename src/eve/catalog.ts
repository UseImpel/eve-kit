...
export const EVE_KIT_PROVIDERS: readonly EveKitProvider[] = [
  ...
  },
  {
    ...
    summary:
      "Read, search, symbol-context, impact, trace, diff-impact, and index-status tools backed by the multi-tenant Impel code-intelligence service. Repository identity and org/run headers come only from server-prepared Eve context.",
    envVars: [
      {
      ...
      },
      {
        ...
        sensitive: true,
        purpose:
          "Runtime bearer key. The tool adds server-derived x-impel-org-id and x-impel-run-id headers; agents never supply either identity.",
      },
    ],
    setupSteps: [
