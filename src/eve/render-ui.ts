...
} satisfies Record<(typeof RENDER_UI_COMPONENT_TYPES)[number], z.ZodType>;

function elementSchemaFor<T extends keyof typeof componentPropSchemas>(
  type: T,
  props: (typeof componentPropSchemas)[T]
) {
...
export const RENDER_UI_PROMPT =
  "When a response benefits from structure, call render_ui with " +
